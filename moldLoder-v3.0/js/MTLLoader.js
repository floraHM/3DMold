...
Object.assign( THREE.MTLLoader.prototype, THREE.EventDispatcher.prototype, {
	...
	parse: function ( text ) {
        ...
        //    console.log('key:' + key);
			...
			//	console.log(materialsInfo[value]);
			} else if ( info ) {

				//HuangMei-2017/11/20 修改增加
				if(key === 'kd'){
				//	console.log(info.name +": "+ value);
                    var ss = value.split( delimiter_pattern, 3 );
                    if( parseFloat( ss[ 0 ] )=== 0 && parseFloat( ss[ 1 ] )===0 && parseFloat( ss[ 2 ] )===0 ){
                    	info[ key ] = [0.5, 0.5, 0.5];
                    //	console.log('modified kd:'+info[key]);
					}
					else{
